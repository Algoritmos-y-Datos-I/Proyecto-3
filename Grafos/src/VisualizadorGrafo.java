...
/**
 * Clase que representa un visualizador de grafos. Muestra los nodos y aristas de un grafo
 * con colores específicos para nodos de inicio, nodos de destino, nodos en el camino,
 * y nodos comunes. Utiliza el algoritmo de Dijkstra para resaltar las rutas específicas en el grafo.
 */
public class VisualizadorGrafo extends JFrame {
     ...
     *
     * @param grafo  Grafo que se visualizará.
     * @param camino Lista de nodos que representan la ruta específica a resaltar en el grafo.
     */
    ...
    /**
     * Método que se llama automáticamente para pintar los nodos y aristas en el JFrame.
     *
     * @param g Graphics utilizado para dibujar en el JFrame.
     */
    @Override
